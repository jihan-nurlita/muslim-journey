...
class EnumValues<T> {
  Map<String, T> map;
  Map<T, String> reverseMap; // Changed from late to normal variable

  EnumValues(this.map)
      : reverseMap = map.map((k, v) => MapEntry(v, k)); // Initialize here

  Map<T, String> get reverse => reverseMap; // No need for null check
}
